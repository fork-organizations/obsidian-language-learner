...
export default {
    ...
    "Export Ignores": "Export Ignores",
    "Export Word": "Export Word",
    "Export Word and Phrase": "Export Word and Phrase",
    "Words exported successfully": "Words exported successfully",
    ...
    "word": "word",
    "Copy All": "Copy All",
    "No notes or sentences for this word": "No notes or sentences for this word",
    "Notes copied": "Notes copied",
    "Sentences copied": "Sentences copied",
    "All content copied": "All content copied",
    "Failed to copy": "Failed to copy",
    "Failed to load word details": "Failed to load word details",
    "Close": "Close",
    ...
    "Select the format of the file to import": "Select the format of the file to import",
    "JSON format: Array of word objects with expression, meaning, status, type, tags, etc.": "JSON format: Array of word objects with expression, meaning, status, type, tags, etc.",
    "CSV format: Expression,Meaning,Status,Type,Tags,Date": "CSV format: Expression,Meaning,Status,Type,Tags,Date",
    "SQLite3 format: A .sqlite or .db database file exported from this plugin": "SQLite3 format: A .sqlite or .db database file exported from this plugin",
    "Select File": "File",
